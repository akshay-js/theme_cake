	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="bbt" href="#"><i class="fa fa-diamond "></i> Diamond Category<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/shape'); ?>">shape</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/color'); ?>">Color</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/clarity'); ?>">Clarity</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/cut'); ?>">Cut</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/sym'); ?>">Sym</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/pol'); ?>">Pol</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/flo'); ?>">Flo</a>
                        </li>
                        <li>
                            <a href="<?php echo $this->Url->build('/admin/master/masters/index/lab'); ?>">Lab</a>
                        </li>
                    </ul>
                </li>
			</ul>
