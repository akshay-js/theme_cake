 <!-- Header Section -->
                        ...
                        <div class="filter-result 01">
                                <div class="col-lg-6 col-md-7 col-sm-9 col-xs-12 pull-left">
                                    <div class="company-left-info pull-left">
                                        <img src="images/company-logo.png" alt="Photo" /> 
                                    </div>
                                    <div class="desig">
                            ...
                            <div class="filter-result 03">
                                <div class="col-lg-6 col-md-7 col-sm-9 col-xs-12 pull-left">
                                    <div class="company-left-info pull-left">
                                        <img src="images/company-logo2.png" alt="Photo" /> 
                                    </div>
                                    <div class="desig"> 
            ...
            <div class="container main-container posts-list">
            	    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 post post-01">
                    	<div class="post-thumb">
                       		<img src="images/post-image1.jpg" alt="Photo" /> 
                               <div class="post-date">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 post post-02">
                    	<div class="post-thumb">
                       		<img src="images/post-image2.jpg" alt="Photo" /> 
                               <div class="post-date">
                                    <span class="date postdate">15</span>
                                    <span class="date postmonth">Feb</span>
                                </div>
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 post post-03">
                    	<div class="post-thumb">
                       		<img src="images/post-image3.jpg" alt="Photo" /> 
                               <div class="post-date">
                                    <span class="date postdate">15</span>
                                    <span class="date postmonth">Feb</span>
                                </div>
    ...
    <!-- Blue Banner-->
    <!-- Testimionals Slider-->
    	<div class="container-fluid testimionals" style="background:url(images/testbg.png);">
			<div class="row">
            <div class="container main-container">
            	<div class="col-lg-12">
                    <div id="testio" class="owl-carousel owl-template">
                      <!--Slides-->
                      <div class="item">
                      		<img src="images/tes-profile.png" alt="Photo" /> 
                            <div class="info">
                            	<h5>Anna Smith</h5>
    ...
    <!-- Clients Slider-->
        ...
        <div class="row">
            <div class="container main-container">
                    <div class="col-lg-12">
                        <ul>
                            <li><img src="images/client1.png" alt="Photo" /> </li>
                            <li><img src="images/client2.png" alt="Photo" /> </li>
                            <li><img src="images/client3.png" alt="Photo" /> </li>
                            <li><img src="images/client4.png" alt="Photo" /> </li>
                            <li><img src="images/client1.png" alt="Photo" /> </li>
                        </ul>
					</div>
                </div>
