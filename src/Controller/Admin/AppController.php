...
class AppController extends Controller
{
	...
	public function clearCache(){
		...
		Cache::delete('allCatSideBarPromotion','longlong');
		Cache::delete('headBlockPromotion','longlong');
		Cache::delete('allCatPromotion','longlong');
		Cache::delete('online_casino_country','longlong');
		// Cache::delete('featured_guide','longlong');
